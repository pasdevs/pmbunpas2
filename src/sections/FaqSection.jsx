        ...
        <details className="group rounded-2xl bg-white p-4 shadow-sm">
          ...
          <div className="overflow-hidden transition-all duration-300 max-h-0 opacity-0 group-open:max-h-96 group-open:opacity-100">
            <p className="mt-2 text-sm text-slate-600">
              ...
              <br />
              <br />
              <a href="https://pmb.unpas.ac.id/form_refund" target="_blank" className="text-emerald-500 font-semibold underline mt-8">Dokumen Persetujuan Ketentuan Refund</a>
              <br />
              <br />
              <a href="https://pmb.unpas.ac.id/form_refund_fk" target="_blank" className="text-emerald-500 font-semibold underline mt-8">Dokumen Persetujuan Ketentuan Refund Kedokteran</a>
            </p>
          </div>
        </details>
      </div>
