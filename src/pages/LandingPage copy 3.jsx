...
import {
  Scale, Users, Cog, BarChart3, BookOpen, Palette, Stethoscope, GraduationCap, Info, Laptop, Award, FileText, Repeat, UserPlus, Shuffle, UploadCloud, CheckCircle2,
} from "lucide-react";
      ...
      <div className="mx-auto max-w-6xl px-4 pb-16">
        ...
        <div id="sticky-header" className="sticky top-0 z-50 bg-white/80 backdrop-blur-md">
          ...
          <header className="flex items-center justify-between py-4">
            ...
            <div className="hidden md:flex items-center gap-6 text-sm">
              ...
              <button className="text-slate-600 hover:text-emerald-700 cursor-pointer" onClick={() => scrollToSection("ketentuan-refund")}>Ketentuan Refund</button>
        ...
        <section className="relative -mx-4 overflow-hidden rounded-3xl">
          ...
          <div className="absolute inset-0">
            ...
            />
            {/* Overlay Gradient */}
            <div className="absolute inset-0 bg-gradient-to-r from-emerald-900/90 via-emerald-800/70 to-emerald-600/40"></div>
          </div>

          {/* Content */}
          <div className="relative z-10 px-6 py-16 md:px-12 md:py-24 text-white">
            {/* Ini biar teksnya tetap sejajar dengan section lain */}
            <div className="mx-auto max-w-6xl">
              <div className="max-w-2xl space-y-6">
                ...
                <p className="text-sm sm:text-base text-white/90">
                  ...
                  <br />
                  Kuliah bukan cuma soal gelar — ini soal masa depan kamu.
                </p>
                ...
                {/* Trust Info */}
                <div className="flex flex-wrap gap-6 pt-6 text-sm sm:text-base font-semibold">
                  <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-3">
                    <span className="text-xl">🎓</span>
                    <span>Pilihan Prodi Favorit</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="text-xl">🤝</span>
                    <span>Didampingi Sampai Registrasi</span>
                  </div>
                </div>
